...
class HiveDb {
  ...
  Future<void> _seedCategories() async {
    ...
    final categories = [
      ...
      {'id': 'cat_2', 'name': 'Kemeja', 'iconPath': 'shirt'},
      {'id': 'cat_3', 'name': 'Jaket', 'iconPath': 'jacket'},
      {'id': 'cat_4', 'name': 'Hoodie', 'iconPath': 'hoodie'},
      {'id': 'cat_5', 'name': 'Aksesoris', 'iconPath': 'accessories'},
      {'id': 'cat_6', 'name': 'Celana', 'iconPath': 'pants'},
    ];
  ...
  Future<void> _seedProducts() async {
    ...
    final products = [
      ...
      },
      {
        ...
        'isFavorite': false,
        'isActive': true,
        'description': 'Jaket denim klasik yang timeless, cocok untuk berbagai gaya.',
        'availableSizes': ['M', 'L', 'XL'],
        'stock': 20,
        'weight': 600,
      },
      ...
      },
      {
        ...
        'isFavorite': false,
        'isActive': true,
        'description': 'Dompet kulit minimalis dengan desain sleek dan banyak kompartemen.',
